	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper" >
				<div class="container">
				<h2>Agriculture Farm Management System</h2>
				<p>Sell Your Product On Our Market</p>
				<br><br>
				<center>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">AFMS &copy; </h3>
		<!--	<div class="logo">
				<a href="index.php"><img src="images/logo.png" width="200px"></a>
			</div>-->
			<br />
			<p style="font-size:20px;color:white">Digitalized your product by Our market !!!</p>
			<br />
		</div>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agriculture Farm Management<span>Md. Naim Ahammed, Shoaib Apu</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">+880 1567-870631</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:md.naim.engr@gmail.com" style="color:white">md.naim.engr@gmail.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About AFMS</b></span>
				AFMS is e-commerce trading platform for grains & grocerries...
			</p>
